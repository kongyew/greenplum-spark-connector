...
# Use Cases specific
export DC_USE_CASE1_SCRIPT="docker-compose -f usecase1/docker-compose_spark.yml"
...
export DC_USE_CASE4_SCRIPT="docker-compose -f usecase4/docker-compose_spark.yml"
